...
function renderTrain() {
  const trainSentenceTexts = [
    ...
    "ปู ม้า อยู่ ทะ เล","เต่า ดำ อยู่ ใน น้ำ","จระ เข้ อยู่ ใน น้ำ","ปลา ทู อยู่ ทะ เล","แม่ กา ดู ปู นา","หมา ใหญ่ ไล่ แม่ กา","หมู ป่า ไล่ ตี งู","เต่า นา อยู่ ใน ตะ กร้า"
  ];
