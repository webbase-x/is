...
const WORD_EMOJI = Object.freeze({
  "กา":"🐔","ปลา":"🐟","เต่า":"🐢","ปู":"🦀","มือ":"✋","ตา":"👁️","ชา":"🍵","แพ":"🛶","รู":"⭕","นา":"🌾","วัว":"🐄","เสือ":"🐯","แมว":"🐱","หมู":"🐷","ม้า":"🐴","ไผ่":"🎋",
  "โบ":"🎀","ไข่":"🥚","เล้า":"🏠","ไหว้":"🙏","แคร่":"🛏️","เกา":"🖐️","แฉะ":"💧","บ่อ":"🕳️","หัว":"🙂","ลา":"🫏","ค้า":"🛍️",
  "ไฟ":"🔥","แกะ":"🐑","งอ":"〰️","ห่อ":"🎁","กลัว":"😨","คู่":"👫","ตู้":"🗄️","ซื้อ":"🛒","ก้าว":"👣","กะทิ":"🥥","ใบไม้":"🍃","ขา":"🦵","ผีเสื้อ":"🦋","ดู":"👀","พ่อ":"👨","แม่":"👩","หมี":"🐻","งู":"🐍","ไก่":"🐔","ปลาโลมา":"🐬","จระเข้":"🐊",
  "กบ":"🐸","นก":"🐦","เด็ก":"🧒","จาน":"🍽️","เก้าอี้":"🪑","บ้าน":"🏠","ดิน":"🟤","มด":"🐜","เข็ม":"🪡","ลิง":"🐒","กลอง":"🥁","ขนม":"🍪","ดอกไม้":"🌸",
...
function renderTrain() {
  const trainSentenceTexts = [
    ...
    "หมา เห่า หมู","หมู หา ใบ ไม้","งู ชู คอ","ปู มี ขา","ไก่ ดุ หมา","กา หา ปลา","ปลา โผ ไป มา","โค ดู หมา","เต่า ถู ขา","เสือ ดู หมู ป่า",
    "ปู่ มี ภู เขา","ย่า ไป ป่า","ตา มี นา","แม่ พา พี่ ไป ทะ เล","อา เจอ งู","กา เกาะ ตะ ปู","ปู ไต่ หญ้า","หมี หา ปู","ผี มา หา","หนู ถู รู",
    "พ่อ ซื้อ เสื้อ สี ฟ้า","พี่ ให้ ยา น้า","อา ใส่ กำ ไล","ป้า เท ชา","หมา เห่า งู","หมู ดู กา","งู ล่า หนู","ไก่ ป่า ตี กา","อา ซื้อ ปลา ทู","โค ป่า ดู ไก่",
    "เสือ ขู่ โค","หมี ดำ ทำ ดี","ตา ถู หัว เข่า","แม่ ชี้ หมา ป่า","พ่อ ดี ใจ","พี่ มี ไฝ","น้า จำ คำ ปู่","ป้า ซื้อ เงาะ","หมา ไล่ หมู ป่า","หมา ฉี่ ใส่ เสา",
