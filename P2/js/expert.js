...
// This file is intentionally local-only: no Authentication, Database,
// Realtime, Presence, Broadcast, or score records are sent to Supabase.
...
event("เปิดห้องทดลอง 123456 · ข้อมูลอยู่ในหน้านี้เท่านั้น");
setupToolbar();
renderAll();
