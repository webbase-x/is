...
const PLAN_4_LESSON_FLOW = freezeLessonFlow(addCompetitionResultSteps([
  ...
  },
  {
    ...
    screen: {
      ...
      message: "ตอบให้ถูกอย่างน้อย 3 จาก 5 ข้อ เพื่อรับดาวดิจิทัล", icon: "🗝️",
...
const PLAN_6_LESSON_FLOW = freezeLessonFlow(addCompetitionResultSteps([
  ...
  },
  {
    ...
    screen: { eyebrow: "ขั้นที่ 3 · ไขรหัสรูปเขียน", title: "ถอดรหัสศิลาจารึก", message: "อ่านความหมาย แล้วเลือกรูปเขียนของคำให้ถูกต้อง", icon: "🗿", bullets: ["มีทั้งหมด 10 ข้อ", "สังเกตตัวสะกดให้ละเอียด", "อ่านเฉลยหลังตอบทุกข้อ"] },
  },
  {
  ...
  },
  {
    ...
    screen: { eyebrow: "ประเมินความเข้าใจ", title: "ด่านดาวพิชิตแม่กด", message: "ตอบให้ถูกอย่างน้อย 3 จาก 5 ข้อ เพื่อรับดาวดิจิทัล", icon: "🏆", bullets: ["ฟังเสียงท้ายคำ", "สังเกตรูปตัวสะกด", "ตรวจคำตอบก่อนเลือก"] },
  },
  {
