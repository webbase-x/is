...
function renderResult(){
  ...
  $("#stage").innerHTML=`<section class="result"><div class="result-medal">${passed?"🏆":"🌟"}</div><h2>${passed?"ผู้พิชิตมาตราแม่กง":"เก่งขึ้นอีกก้าวแล้ว"}</h2><p>แบบทดสอบท้ายคาบถูก ${exitCorrect} จาก 5 ข้อ · เกณฑ์ผ่าน 3 ข้อ</p><div class="result-score">⭐ คะแนนรวม ${state.score}</div><p>${passed?"ได้รับสติกเกอร์ดาวดิจิทัล! หนูจำได้แล้วว่า คำแม่กงมี ง เป็นตัวสะกด":"ลองอีกครั้งเพื่อรับสติกเกอร์ดาวนะ"}</p><button id="restartButton" class="primary-button" type="button">เล่นอีกครั้ง ↻</button></section>`;
