...
(function installEmojiFallback() {
  ...
  const ICONS = {
    ...
    owl: '<circle cx="32" cy="33" r="23" fill="#8a5a35"/><circle cx="22" cy="29" r="11" fill="#fff"/><circle cx="42" cy="29" r="11" fill="#fff"/><circle cx="22" cy="29" r="4" fill="#25304f"/><circle cx="42" cy="29" r="4" fill="#25304f"/><path fill="#f7bd47" d="m27 37 5-6 5 6-5 7Z"/>',
    tiger: '<path fill="#f29b38" d="M13 27c0-13 8-21 19-21s19 8 19 21v13c0 13-8 20-19 20s-19-7-19-20Z"/><path fill="#44304d" d="M16 17 9 10l14 3Zm32 0 7-7-14 3ZM20 8l4 14h5L27 7Zm24 0-4 14h-5l2-15Z"/><path fill="none" stroke="#513049" stroke-width="3" d="M19 27h9m17 0h-9M25 45c5 4 9 4 14 0"/><circle cx="23" cy="30" r="2" fill="#222"/><circle cx="41" cy="30" r="2" fill="#222"/>',
    whale: '<path fill="#4b9ed8" d="M9 38c4-14 18-22 34-18 9 2 13 8 12 14-1 7-8 13-19 15-11 2-22-2-27-11Z"/><path fill="#4b9ed8" d="M18 21c-4-8-12-8-14-3 5-1 8 2 10 7Zm20-1c4-8 12-8 14-3-5-1-8 2-10 7Z"/><circle cx="43" cy="33" r="2" fill="#fff"/><circle cx="43" cy="33" r="1" fill="#222"/><path fill="none" stroke="#fff" stroke-width="2" d="M18 45c7 3 16 3 23-1"/>',
    rabbit: '<path fill="#f3c9d8" d="M21 22C13 11 16 3 23 5c5 2 7 10 7 17h4c0-7 2-15 7-17 7-2 10 6 2 17 4 4 6 9 6 16 0 12-8 20-17 20s-17-8-17-20c0-7 2-12 6-16Z"/><circle cx="25" cy="34" r="2" fill="#3e3556"/><circle cx="39" cy="34" r="2" fill="#3e3556"/><path fill="none" stroke="#3e3556" stroke-width="2" d="M29 44c2 2 4 2 6 0"/>',
    fox: '<path fill="#ef7a57" d="m10 18 7-12 12 7h6l12-7 7 12v23c0 12-9 18-22 18S10 53 10 41Z"/><path fill="#fff" d="M12 42c8-3 14-1 20 5 6-6 12-8 20-5-3 8-10 12-20 12s-17-4-20-12Z"/><circle cx="24" cy="32" r="2"/><circle cx="40" cy="32" r="2"/>',
    panda: '<circle cx="32" cy="33" r="23" fill="#fff"/><circle cx="14" cy="15" r="9" fill="#222"/><circle cx="50" cy="15" r="9" fill="#222"/><ellipse cx="22" cy="30" rx="6" ry="9" fill="#222" transform="rotate(-25 22 30)"/><ellipse cx="42" cy="30" rx="6" ry="9" fill="#222" transform="rotate(25 42 30)"/><circle cx="24" cy="31" r="2" fill="#fff"/><circle cx="40" cy="31" r="2" fill="#fff"/><circle cx="32" cy="40" r="4" fill="#222"/>',
    lion: '<circle cx="32" cy="32" r="27" fill="#d88c2d"/><circle cx="32" cy="34" r="18" fill="#f7bd8d"/><circle cx="25" cy="32" r="2" fill="#3d2a3e"/><circle cx="39" cy="32" r="2" fill="#3d2a3e"/><path fill="none" stroke="#3d2a3e" stroke-width="2" d="M27 43c3 3 7 3 10 0"/>',
    frog: '<circle cx="32" cy="35" r="22" fill="#55bd73"/><circle cx="20" cy="16" r="10" fill="#55bd73"/><circle cx="44" cy="16" r="10" fill="#55bd73"/><circle cx="20" cy="16" r="4" fill="#fff"/><circle cx="44" cy="16" r="4" fill="#fff"/><circle cx="20" cy="16" r="2"/><circle cx="44" cy="16" r="2"/><path fill="none" stroke="#1f704f" stroke-width="3" d="M22 40c6 5 14 5 20 0"/>',
    octopus: '<path fill="#e979a9" d="M12 37c0-15 9-25 20-25s20 10 20 25v10c6-2 8 6 2 9-5 2-9-2-11-6-1 7-7 11-11 5-4 6-10 2-11-5-2 4-6 8-11 6-6-3-4-11 2-9Z"/><circle cx="25" cy="33" r="3" fill="#fff"/><circle cx="39" cy="33" r="3" fill="#fff"/><circle cx="25" cy="33" r="1.5"/><circle cx="39" cy="33" r="1.5"/>',
    butterfly: '<path fill="#ef668d" d="M31 31C20 11 7 10 8 23c1 8 8 13 19 15-11 1-18 8-13 15 6 8 14-1 18-14 4 13 12 22 18 14 5-7-2-14-13-15 11-2 18-7 19-15 1-13-12-12-23 8Z"/><rect x="30" y="25" width="4" height="26" rx="2" fill="#44304d"/>',
    rocket: '<path fill="#ef7a57" d="M32 6c11 4 17 14 17 28 0 9-5 16-17 22-12-6-17-13-17-22 0-14 6-24 17-28Z"/><circle cx="32" cy="27" r="6" fill="#eef5ff"/><path fill="#5b3fd0" d="M17 36 7 42l11 3Zm30 0 10 6-11 3Z"/><path fill="#f7bd47" d="M25 52c1 7 4 9 7 11 3-2 6-4 7-11Z"/>',
    elephant: '<path fill="#9ea8bb" d="M13 37c0-15 10-25 23-25s19 8 19 21c0 9-5 13-11 13v8h-7v-9h-8v9h-7v-9c-6 0-9-3-9-8Z"/><path fill="#9ea8bb" d="M48 30c12-1 13 7 8 13-3 3-7 3-10 2v-7c5 2 7 0 2-8Z"/><circle cx="39" cy="29" r="2" fill="#25304f"/>',
    turtle: '<ellipse cx="31" cy="35" rx="22" ry="16" fill="#4ea66b"/><path fill="#9acb76" d="M18 35c2-10 11-16 22-12 6 2 10 7 10 13 0 7-6 12-15 13-9 1-16-4-17-14Z"/><circle cx="54" cy="35" r="7" fill="#9acb76"/><circle cx="56" cy="33" r="1.5" fill="#25304f"/><path fill="none" stroke="#2d7c55" stroke-width="2" d="M24 25v20m12-22v24m11-18-30 12"/>',
    cow: '<path fill="#fff" d="M13 26c0-13 8-20 19-20s19 7 19 20v15c0 11-8 17-19 17s-19-6-19-17Z"/><path fill="#33304a" d="M18 12c-5-5-10-2-9 5 3 3 7 3 10 0Zm28 0c5-5 10-2 9 5-3 3-7 3-10 0Z"/><ellipse cx="23" cy="26" rx="6" ry="8" fill="#33304a"/><ellipse cx="41" cy="44" rx="7" ry="5" fill="#e6a1ab"/><circle cx="27" cy="32" r="2"/><circle cx="39" cy="32" r="2"/>',
    bear: '<circle cx="32" cy="34" r="23" fill="#a96f43"/><circle cx="15" cy="16" r="9" fill="#a96f43"/><circle cx="49" cy="16" r="9" fill="#a96f43"/><circle cx="24" cy="32" r="2" fill="#25304f"/><circle cx="40" cy="32" r="2" fill="#25304f"/><ellipse cx="32" cy="41" rx="8" ry="6" fill="#e7b684"/><circle cx="32" cy="40" r="2" fill="#25304f"/>',
    snake: '<path fill="none" stroke="#58b86f" stroke-linecap="round" stroke-width="12" d="M14 45c12 12 29 0 21-10-7-9-22 1-11-14 6-8 14-8 25-1"/><circle cx="49" cy="20" r="6" fill="#58b86f"/><circle cx="51" cy="19" r="1.5" fill="#25304f"/>',
    chicken: '<circle cx="31" cy="34" r="19" fill="#f7bd47"/><circle cx="23" cy="29" r="2"/><path fill="#ef7a57" d="m50 31 10 5-10 5Z"/><circle cx="38" cy="14" r="5" fill="#ef668d"/><circle cx="31" cy="10" r="5" fill="#ef668d"/><path fill="none" stroke="#ef7a57" stroke-linecap="round" stroke-width="5" d="M23 52v7m14-7v7"/>',
    bird: '<path fill="#4b9ed8" d="M10 38c4-14 17-23 31-20 10 2 14 10 13 18-1 10-10 18-23 19-10 0-18-6-21-17Z"/><path fill="#f7bd47" d="m51 31 11 5-11 6Z"/><circle cx="43" cy="30" r="2" fill="#25304f"/><path fill="none" stroke="#fff" stroke-width="3" d="M18 38c7-5 14-5 21-1"/>',
    dolphin: '<path fill="#4b9ed8" d="M10 42c12-4 19-14 21-28 7 5 8 13 6 20 8-7 13-8 17-6-3 9-11 17-22 22-8 3-16 1-22-8Z"/><path fill="#4b9ed8" d="m26 18-9-10 14 5Z"/><circle cx="42" cy="31" r="2" fill="#25304f"/>',
    horse: '<path fill="#a96f43" d="M16 53c-1-17 1-30 8-38l-7-9 15 7c4-3 9-4 14-2l9-5-4 12c3 7 3 19-1 28-5 9-22 12-34 7Z"/><circle cx="27" cy="29" r="2" fill="#25304f"/><circle cx="43" cy="29" r="2" fill="#25304f"/><path fill="none" stroke="#fff" stroke-width="4" d="M31 7c3 9 8 12 15 14"/>',
    donkey: '<path fill="#9ea8bb" d="M16 53c-1-17 1-30 8-38l-7-12 15 10c4-3 9-4 14-2l9-8-3 16c3 7 3 19-1 28-5 9-22 12-35 6Z"/><circle cx="27" cy="29" r="2" fill="#25304f"/><circle cx="43" cy="29" r="2" fill="#25304f"/><path fill="#6b7489" d="M22 8 17 2l14 11Zm26 0 6-6-14 12Z"/>',
    crocodile: '<path fill="#55a66c" d="M5 38c8-12 19-18 32-16l20 6c4 2 4 9 0 11l-19 7c-13 4-25 1-33-8Z"/><path fill="#fff" d="m37 37 18-5-18 13Z"/><circle cx="45" cy="28" r="3" fill="#55a66c"/><circle cx="46" cy="27" r="1" fill="#25304f"/><path fill="none" stroke="#2d7c55" stroke-width="2" d="M16 30v15m10-18v20"/>',
  };
