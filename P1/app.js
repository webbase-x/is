...
const vocabulary = [
  ['ภูผา','👦','ชื่อเด็กในเรื่อง','ภู – ผา'],
  ['พ่อ','👨','พ่อของภูผา','พ่อ'],
  ['แม่','👩','แม่ของภูผา','แม่'],
  ['หา','🔎','มองหรือค้นเพื่อให้พบ','หา'],
  ['ให้','🎁','มอบสิ่งหนึ่งแก่ผู้อื่น','ให้'],
  ['ได้','🙌','ได้รับหรือทำสำเร็จ','ได้'],
  ['ดีใจ','😄','มีความรู้สึกยินดี','ดี – ใจ'],
  ['ดูแล','🤲','เอาใจใส่','ดู – แล'],
  ['รัก','❤️','มีความรักและผูกพัน','รัก']
];

const shadowVocabulary = [
  ['ภูผา','ภูผา.png'],['พ่อ','พ่อ.png'],['แม่','แม่.png'],['หา','หา.png'],
  ['ให้','ให้-ได้.png'],['ได้','ให้-ได้.png'],['ดีใจ','ดีใจ.png'],['ดูแล','ดูแล.png'],['รัก','รัก.png']
];
let currentShadow = 0;
...
const bingoExampleWords = ['ภูผา','พ่อ','แม่','หา','ให้','ได้','ดีใจ','ดูแล','รัก','ใบโบก','ใบบัว','ตา','ขา','หู','งวง','มี'];
const bingoExamples = [
...
const baseSentenceChallenges = [
  ...
  [['ภูผา','รัก','ใบโบก']],
  [['ภูผา','ดีใจ','ได้','ดูแล','ใบโบก']],
  [['ภูผา','รัก','ใบบัว']],
  [['ภูผา','ดีใจ','ได้','ดูแล','ใบบัว']],
  [['ใบโบก','ใบบัว','รัก','ภูผา']]
];
const challenges = [
