...
export default function ResearchPlatform() {
  ...
  const [analysisProject, setAnalysisProject] = useState<ResearchProject | null>(null);
  ...
  async function signOut() {
    if (demo) { setDemo(false); setAnalysisProject(null); return; }
    await getSupabaseClient()?.auth.signOut(); setAnalysisProject(null);
  }
